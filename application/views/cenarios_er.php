        ...
        <div class="col-sm-3 col-md-3">
            <div class="panel-group">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            <a href="" class="aaccordion"><span class="glyphicon glyphicon-circle-arrow-right">
                            </span>  Automoveis</a>
                        </h4>
                    </div>
                </div>
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            <a href="" class="maccordion"><span class="glyphicon glyphicon-circle-arrow-right">
                            </span>  Medico</a>
                        </h4>
                    </div>
                </div>
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            <a href="" class="rcaccordion"><span class="glyphicon glyphicon-circle-arrow-right">
